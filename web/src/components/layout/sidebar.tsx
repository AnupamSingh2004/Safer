  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        href: '/dashboard/operator/workload',
        icon: Target,
        roles: ['operator'],
        permissions: ['operator.view_workload'],
      },
      {
        id: 'operator-communication',
        label: 'Communication',
        href: '/dashboard/communication',
        icon: Phone,
        roles: ['operator'],
        permissions: ['operator.communicate'],
      },
    ],
  },
  {
    ...
    children: [
      ...
      {
        id: 'operators-assignments',
        label: 'Assignments',
        href: '/dashboard/operators/assignments',
        icon: ClipboardList,
        roles: ['admin', 'super_admin'],
      ...
      },
      {
        ...
        label: 'Performance',
        href: '/dashboard/operators/performance',
        icon: TrendingUp,
        roles: ['admin', 'super_admin'],
        permissions: ['admin.view_performance'],
      },
    ],
  },
  {
