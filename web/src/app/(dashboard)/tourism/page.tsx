        ...
        <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-lg p-6 text-white">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="text-sm text-green-200">Live Monitoring</div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Button
              ...
              className={isRealTimeEnabled ? 'bg-green-50 text-green-600 border-green-200' : ''}
            >
        ...
        <div className="space-y-3">
          {mockTourismStats.topDestinations.map((dest, index) => (
            <div key={dest.name} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              ...
              <div className="text-right">
                <div className="font-medium">{dest.visitors.toLocaleString()}</div>
        ...
        {mockHeatMapZones.map((zone) => (
          <Card key={zone.id} className="p-6">
            <div className="flex items-start justify-between mb-4">
              ...
              <Badge variant={
                zone.riskLevel === 'safe' ? 'success' :
                zone.riskLevel === 'moderate' ? 'warning' :
                'destructive'
              }>
                {zone.riskLevel}
              </Badge>
